...
function App() {
  ...
  const [nominated, setNominated] = useState(
    JSON.parse(localStorage.getItem('nominated')) || {}
  );
  const [input, setInput] = useState('Ensemble');
  ...
  // a request is fired only after 500ms of the last keystroke
      ...
      <header className={styles.header}>
        <div className={styles.headerContentWrapper}>
          <div className={styles.headerTextWrapper}>
            <h1 className={styles.headerMain}>Movie Search Engine</h1>
        ...
        <div className={styles.mainContentWrapper}>
          ...
          <div className={styles.moviesWrapper}>
            <div className={styles.moviesInputWrapper}>
              ...
              />
              <BiSearch
                className={styles.moviesSearchIcon}
                color="#525158"
                size="16px"
              />
            </div>
            ...
            {error === 'Too many results.' ? (
              <p>Too many results for the title "{input}".</p>
            ) : (
              <p>{error}</p>
            )}
              ...
              {fetchError ? (
                ...
                movies.map((movie) => (
                  <MovieCard
                    ...
                    disableNominate={
                      Object.keys(nominated).length >= 5 ? true : false
                    }
